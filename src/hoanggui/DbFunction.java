...
public class DbFunction 
{
    ...
    //Fixed Assets : retrieving data from the Input class
     ...
     public void selectDataFromFixedAssets() throws Exception
     {
         {
        Connection myDbConn;
        String dbQuery;
        ...
        PreparedStatement statement = myDbConn.prepareStatement("SELECT fixedAssetsValue FROM FixedAssetsTable");
